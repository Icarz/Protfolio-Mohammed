...
const TECH_COLORS = {
  ...
  PostgreSQL: 'text-sky-300 bg-sky-500/10 border-sky-500/20',
...
export const DEFAULT_DATA = {
  ...
  projects: [
    ...
    },
    {
      id: 9,
      title: 'NutriTrack',
      description: 'A platform built for nutritionists to manage clients, create personalized diet programs, and track client progress over time.',
      image: '/NutriTrack.png',
      technologies: ['React', 'Node.js', 'JavaScript', 'PostgreSQL'],
      category: 'Full Stack',
      section: 'web',
      featured: false,
      github: 'https://github.com/Icarz/NutriTrack',
      live: 'https://nutri-pro-track.vercel.app/',
    },
  ],
  skills: {
    proficiency: [
